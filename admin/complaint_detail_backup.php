...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_status'])) {
    ...
    if ($stmt->execute()) {
        ...
        $success = 'गुनासो सफलतापूर्वक अद्यावधिक गरियो।';
    } else {
        $error = 'अद्यावधिक गर्दा त्रुटि भयो: ' . $conn->error;
    }
}
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <select name="status" class="form-select" required>
                            ...
                            <option value="in-progress" <?php echo $complaint['status'] == 'in-progress' ? 'selected' : ''; ?>>प्रगतिमा</option>
